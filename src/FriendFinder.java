...
public class FriendFinder {
	...
	public Set<String> findClassmates(Student theStudent) {
		...
		if (theStudent == null) throw new IllegalArgumentException("Student is null");
		if (classesDataSource == null) throw new IllegalStateException("Classes Source is null");
		if (studentsDataSource == null) throw new IllegalStateException("Student Source is null");
		
		String name = theStudent.getName();
		if (name == null) throw new IllegalArgumentException("No student name");
